...
public class MainActivity extends AppCompatActivity {
    ...
    // ActionBar içerisinde menü oluşturmak için.
    ...
    // Seçilen menüyü işlemek için yapılması gereken işlem.

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {

        int itemThatWasClickedId = item.getItemId(); // Seçilen öğenin / menünün id ' sini öğrenmek için bu işlem yapıldı
        if (itemThatWasClickedId == R.id.action_search) {

            Context context = MainActivity.this; // Context oluşturuldu , context ' e mainactivity class ı atandı
            // içinde bulunduğumuz activity ile bağlam oluşturmak için context oluşturduk

            String textToShow = "Search Clicked"; // mesaj oluşturuldu
            Toast.makeText(context, textToShow, Toast.LENGTH_LONG).show(); // toast içerisinde mesaj gösterildi.
